 ...
 */
function i18n() {
	load_theme_textdomain( 'tmi', TMI_PATH . '/languages' );
 }
...
function header_meta() {
	$humans = '<link type="text/plain" rel="author" href="' . TMI_TEMPLATE_URL . '/humans.txt" />';

	echo apply_filters( 'tmi_humans', $humans );
}
